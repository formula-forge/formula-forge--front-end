...
function DragDropFile(props) {
    ...
    return (
        <div id="file-area" className={dragActive?"drag-active":""} onClick={handleClick} onDragEnter={handleDrag} onDragLeave={handleDrag} onDragOver={handleDrag} onDrop={handleDrop}>
            <UserAvatar type="big-avatar" userId={props.userId} avatar={imgSrc} />
